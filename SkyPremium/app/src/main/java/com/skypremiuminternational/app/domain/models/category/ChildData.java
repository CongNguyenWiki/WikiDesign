...
public class ChildData implements Serializable {
  ...
  private boolean isAddedAllText = false;
  ...
  public boolean isAddedAllText() {
    return isAddedAllText;
  }

  public void setAddedAllText(boolean addedAllText) {
    isAddedAllText = addedAllText;
  }
}
