package com.skypremiuminternational.app.app.features.profile.booking.detail;
...
import com.skypremiuminternational.app.app.features.profile.booking.detail.property.AmenityAdapter;
import com.skypremiuminternational.app.app.features.profile.booking.room.stepthree.GuestDetailAdapter;
import com.skypremiuminternational.app.app.features.profile.booking.summary.RoomPriceAdapter;
import com.skypremiuminternational.app.app.features.profile.booking.summary.TourismFeeRecyclerAdapter;
...
public class BookingDetailActivity extends BaseActivity<BookingDetailPresenter>
  ...
  public static void start(Context context, String bookingId,
                           List<BookingHistory.Room> rooms,String selectedCategory,String selectedSorting,String position,String isdisplayCancel,String bookingstatus,String canUse) {
    ...
    starter.putExtra("canUse",canUse);
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    canUse = getIntent().getStringExtra("canUse");
    ...
    tvCancel.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
          if(isDisplaycancel && tvCancel.getText().toString().toLowerCase().equalsIgnoreCase(getString(R.string.txt_cancelbookingbutton).toLowerCase())){
            ...
            finish();
            BookingDetailActivity.start(getApplicationContext(), bookingId, rooms,String.valueOf(selectedCategory),String.valueOf(selectedCategory),String.valueOf(position),String.valueOf(isDisplaycancel),String.valueOf(bookingstatus),canUse);
          }
        }
