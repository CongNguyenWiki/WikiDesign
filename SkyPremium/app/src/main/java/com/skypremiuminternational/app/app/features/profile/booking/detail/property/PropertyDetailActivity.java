package com.skypremiuminternational.app.app.features.profile.booking.detail.property;
...
import com.skypremiuminternational.app.app.features.profile.booking.ImagePagerAdapter;
...
public class PropertyDetailActivity extends BaseActivity<PropertyDetailPresenter>
  ...
  private void showNotViewDialog() {
    androidx.appcompat.app.AlertDialog.Builder builder;
    builder = new androidx.appcompat.app.AlertDialog.Builder(this);
    builder
            .setMessage("We are sorry. You do not have the permissions to view this record.")
            .setCancelable(false)
