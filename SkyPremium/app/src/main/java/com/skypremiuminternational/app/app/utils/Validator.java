...
public class Validator {
  ...
  public static boolean isOnlyAphalbeValid(String text) {
    matcherAphal = patternAphalbe.matcher(text);
    return matcherAphal.matches();
  }
