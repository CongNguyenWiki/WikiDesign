...
public class BookingsHistoryActivity extends BaseActivity<BookingHistoryPresenter>
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    presenter.getConfigAndRenderBookingHistory();
  ...
  @Override
  public void renderPermission(List<PermissionProfileItem> value) {

    for (PermissionProfileItem permissionProfileItem : value){
      if (permissionProfileItem.getNavItem().equalsIgnoreCase("My Bookings")){

        canUse = permissionProfileItem.getGetPermissionCanUse();
  ...
  public void render(BookingData bookingHistories, boolean success, String bookingid,int position, ArrayList<BookingHistory.Room> rooms) {
    ...
    BookingDetailActivity.start(BookingsHistoryActivity.this, bookingid, rooms,String.valueOf(selectedCategory),String.valueOf(selectedSorting),String.valueOf(position),String.valueOf(bookingHistories.getDisplayCancelsButton()),String.valueOf(bookingHistories.getLabel_status()),canUse);
  ...
  @Override
  public void renderWebView(String urlTravflex, String token) {
    String lang = "en";
    String country = "sg";
    String currency = "sgd";
    String tokn = token.replace("\"","");
    ...
    webView.loadUrl(urlTravflex+"/"+lang+"/hotel/booking/history?ctry="+country+"&curr="+currency+"&tokn="+tokn);
  }


  /*@Override
  public void setupViewFromConfig(boolean isTravelFlex, String urlTraveflex) {
    if(!isTravelFlex){
  ...
  @Override
  public void renderExpediaHistory() {
  ...
  @Override
  public void renderTravflexHistory(String urlTraveflex) {
    tvToolBarTitle.setText(getString(R.string.profile_my_bookings_label));
    setWebView(urlTraveflex);
  }
}
