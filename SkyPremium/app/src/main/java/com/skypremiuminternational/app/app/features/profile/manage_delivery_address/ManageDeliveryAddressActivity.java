...
import static com.skypremiuminternational.app.app.features.checkout.AddOrEditAddressDialog.ADD_ADDRESS;
import static com.skypremiuminternational.app.app.features.checkout.AddOrEditAddressDialog.EDIT_ADDRESS;
import static com.skypremiuminternational.app.app.features.checkout.AddOrEditAddressDialog.EXTRA_KEY_COUNTRY;
import static com.skypremiuminternational.app.app.features.checkout.AddOrEditAddressDialog.EXTRA_KEY_DIALOG_TYPE;
...
import com.skypremiuminternational.app.app.features.checkout.AddOrEditAddressDialog;
...
public class ManageDeliveryAddressActivity extends BaseActivity<ManageDeliveryAddressPresenter>
  ...
  public void render(UserDetailResponse response) {
    if (response != null) {
      ...
      if (response.getAddresses().size() > 0) {
        ...
        adapter.setData(response.getAddresses());
      } else {
  ...
  public void showDialogNotUse() {
    new AlertDialog.Builder(this).setMessage("We are sorry. You do not have the permissions to utilize this function.")
            .setCancelable(false)
