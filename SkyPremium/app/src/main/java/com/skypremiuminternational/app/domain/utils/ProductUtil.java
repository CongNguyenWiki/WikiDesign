...
//    String specialPrice = "";
//    String timeSalesStatus = "";
//    String displayPlatinumIcon = "";
...
//      } else if(attribute.getAttributeCode().equalsIgnoreCase("category_ids")) {
//        categoryIds = (List<String>) attribute.getValue();
...
//      }else if (attribute.getAttributeCode().equalsIgnoreCase("time_sales_status")
//          && attribute.getValue() != null) {
//        timeSalesStatus = String.format("%s",Math.round(Double.valueOf(attribute.getValue().toString())));
//      }else if (attribute.getAttributeCode().equalsIgnoreCase("display_platinum_icon")
//          && attribute.getValue() != null) {
//        displayPlatinumIcon = attribute.getValue().toString();
//      }
//      // 20200406 - WIKI Toan Tran - add new dealValue
...
//    item.setNew(isNewDetails(newFromDate, newToDate, currentServerTime));
//    item.setDisplayPlatinumIcon(displayPlatinumIcon);
//    item.setTimeSalesStatus(timeSalesStatus);
//    // 20200406 - WIKI Toan Tran - add new dealValue
...
//  public static boolean isNewDetails(String rawFromDate, String rawToDate, String currentServerTime) {
//    Calendar calendar = Calendar.getInstance();
//    DateParser dateParser = DateParser.with(Constants.PATTERN_DATE_TIME);
//    DateParser currentDateParser = DateParser.with(Constants.PATTERN_DATE_TIME);
//
...
//  }
  ...
  public static double coverDiscountPercent(double original, double discount){
    double percent;
    percent = discount/(original/100);
